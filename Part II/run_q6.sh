...
find . -type f -name "*.gch" -exec rm -f {} \;
cd ../
mkdir -p inputs/input_q6
mv -t inputs/input_q6/ gift.txt input.txt
mkdir -p outputs/output_q6
mv -t outputs/output_q6  Event_Timestamp.csv
unlink a.out
