...
find . -type f -name "*.gch" -exec rm -f {} \;
cd ../
mkdir -p inputs/input_q3
mv -t inputs/input_q3/ gift.txt input.txt
mkdir -p outputs/output_q3
mv -t outputs/output_q3 couples.csv compatibility.csv Event_Timestamp.csv happiness.csv 
